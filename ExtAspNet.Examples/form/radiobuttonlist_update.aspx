<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="radiobuttonlist_update.aspx.cs"
    Inherits="ExtAspNet.Examples.form.radiobuttonlist_update" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" Width="700px" runat="server" LabelWidth="120px"
        ...
        <Items>
            <ext:RadioButtonList ID="RadioButtonList1" Label="列表一" runat="server">
                ...
                <ext:RadioItem Text="可选项 2" Value="value2" Selected="true" />
            ...
            <ext:RadioButtonList ID="RadioButtonList2" Label="列表二（竖排）" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </ext:RadioButtonList>
            ...
            <ext:RadioButtonList ID="RadioButtonList4" Label="列表四（空列表）" ColumnNumber="3" ColumnVertical="true"
                runat="server">
            </ext:RadioButtonList>
    ...
    <br />
    <ext:RadioButtonList ID="RadioButtonList3" Width="700px" Label="列表三" ColumnNumber="3"
        ...
        <ext:RadioItem Text="可选项 5" Value="value5" Selected="true" />
        <ext:RadioItem Text="可选项 6" Value="value6" Selected="true" />
        <ext:RadioItem Text="可选项 7" Value="value7" Selected="true" />
