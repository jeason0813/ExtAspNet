<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="radiobuttonlist.aspx.cs"
    Inherits="ExtAspNet.Examples.form.radiobuttonlist" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" Width="700px" runat="server" LabelWidth="160px"
        ...
        Title="简单表单">
        <Items>
            <ext:RadioButtonList ID="RadioButtonList1" Label="列表一" runat="server">
                <ext:RadioItem Text="可选项 1" Value="value1" />
                <ext:RadioItem Text="可选项 2" Value="value2" />
                <ext:RadioItem Text="可选项 3" Value="value3" Selected="true" />
            </ext:RadioButtonList>
            <ext:Button ID="btnServerSetSelectedValue" CssClass="inline" Text="选中上面列表中的第一项" OnClick="btnServerSetSelectedValue_Click"
                runat="server">
            </ext:Button>
            ...
            <ext:RadioButtonList ID="RadioButtonList2" Label="列表二（一列）" ColumnNumber="1" runat="server">
            </ext:RadioButtonList>
            <ext:Label ID="Label1" runat="server" Text="&nbsp;">
            </ext:Label>
            <ext:RadioButtonList ID="rblAutoPostBack" AutoPostBack="true" OnSelectedIndexChanged="rblAutoPostBack_SelectedIndexChanged"
                Label="列表三（自动回发）" ColumnNumber="3" runat="server" ShowRedStar="true" Required="true">
                <ext:RadioItem Text="可选项 1" Value="value1" />
                <ext:RadioItem Text="可选项 2" Value="value2" />
                <ext:RadioItem Text="可选项 3" Value="value3" />
                <ext:RadioItem Text="可选项 4" Value="value4" />
                <ext:RadioItem Text="可选项 5" Value="value5" />
                <ext:RadioItem Text="可选项 6" Value="value6" />
                <ext:RadioItem Text="可选项 7" Value="value7" />
                <ext:RadioItem Text="可选项 8" Value="value8" />
            </ext:RadioButtonList>
            <ext:Label ID="Label2" runat="server" Text="&nbsp;">
            </ext:Label>
            <ext:RadioButtonList ID="rblVertical" Label="列表四（竖排）" ColumnNumber="3" ColumnVertical="true"
            ...
            <ext:Button runat="server" ID="btnSubmit" ValidateForms="SimpleForm1" Text="提交表单" OnClick="btnSubmit_Click">
            </ext:Button>
        </Items>
    </ext:SimpleForm>
    </form>
