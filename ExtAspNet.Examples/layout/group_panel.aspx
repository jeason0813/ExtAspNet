<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_panel.aspx.cs" Inherits="ExtAspNet.Examples.layout.group_panel" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" BodyPadding="5px" runat="server" EnableBackgroundColor="true"
        ...
        <Items>
            <ext:GroupPanel runat="server" AutoHeight="true" Title="分组面板一" ID="GroupPanel1" EnableCollapse="True">
                <Items>
                    <ext:SimpleForm ID="SimpleForm1" runat="server" EnableBackgroundColor="true" ShowBorder="False"
                        ShowHeader="False">
                        <Items>
                            <ext:TextBox ID="TextBox1" Label="名称" runat="server">
                            </ext:TextBox>
                            <ext:TextArea ID="TextArea1" Label="备注" runat="server">
                            </ext:TextArea>
                        </Items>
                    </ext:SimpleForm>
                </Items>
            </ext:GroupPanel>
            <ext:GroupPanel ID="GroupPanel2" EnableBackgroundColor="true" AutoHeight="true" Title="分组面板二"
                runat="server" EnableCollapse="True">
                <Items>
                    <ext:ContentPanel ID="ContentPanel1" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                        runat="server">
    ...
    <br />
    <ext:Button ID="Button2" Text="展开/折叠分组面板二" OnClick="Button2_Click" runat="server">
    </ext:Button>
    </form>
</body>
</html>
