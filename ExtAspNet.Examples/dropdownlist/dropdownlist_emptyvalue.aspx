<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dropdownlist_emptyvalue.aspx.cs"
    Inherits="ExtAspNet.Examples.dropdownlist.dropdownlist_emptyvalue" %>
...
<body>
    ...
    <ext:DropDownList runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" ID="DropDownList1">
