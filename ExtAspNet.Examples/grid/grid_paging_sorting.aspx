<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grid_paging_sorting.aspx.cs"
    Inherits="ExtAspNet.Examples.grid.grid_paging_sorting" %>
...
<body>
    ...
    <ext:Grid ID="Grid1" Title="表格" AllowSorting="true" SortColumn="name" SortDirection="ASC"
        ...
        <Columns>
            ...
            <ext:BoundField Width="60px" SortField="EntranceYear" DataField="EntranceYear" HeaderText="入学年份" />
